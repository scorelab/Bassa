...
# download endpoints
server.add_url_rule(rule='/api/download/start',
                    endpoint='start', view_func=Download.start)
server.add_url_rule(rule='/api/download/kill', endpoint='kill',
                    view_func=Download.kill)
...
server.add_url_rule(rule='/api/login', endpoint='login',
                    view_func=User.login, methods=['POST'])
server.add_url_rule(rule='/api/regularuser', endpoint='regular_user_request', view_func=User.regular_user_request,
                    methods=['POST'])
server.add_url_rule(rule='/api/user', endpoint='add_user_request',
                    view_func=User.add_user_request, methods=['POST'])
...
server.add_url_rule(rule='/api/user', endpoint='get_users_request',
                    view_func=User.get_users_request, methods=['GET'])
...
server.add_url_rule(rule='/api/file', endpoint='send_file_from_path', view_func=sender.send_file_from_path,
                    methods=['GET'])
server.add_url_rule(rule='/api/compress', endpoint='start_compression',
                    view_func=sender.start_compression, methods=['POST'])
server.add_url_rule(rule='/api/compression-progress', endpoint='get_compression_progress',
                    view_func=sender.check_compression_progress, methods=['GET'])
