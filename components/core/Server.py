...
server.add_url_rule(rule='/api/user/drive/<string:user_id>/edit', endpoint='edit_entity',
					view_func=Directory.edit_entity, methods=['PUT'])
server.add_url_rule(rule='/api/user/drive/<string:user_id>/remove', endpoint='remove_entity',
