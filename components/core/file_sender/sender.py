...
def send_file_from_path():
    ...
    try:
        ...
        logging.error(" get file API (/api/get/file) got wrong arguments, thrown an error >> " + str(e) + " <<")
    ...
    try:
        ...
        logging.error("File sending has a exception. We got >> "+str(e)+" << error on file sending")
