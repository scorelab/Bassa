...
describe('Appbar Component Testing', () => {
  ...
  describe('User is logged in', () => {
    ...
    let component;
    beforeEach(() => component = mount(<BrowserRouter><Appbar isloggedIn={true} /></BrowserRouter>));

    it('should display logged in view', () => {
      const buttonDashboard = findByTestAttr(component, 'button-dashboard').at(4);
      ...
      expect(buttonDashboard.props().children[0].props.children).toBe('Dashboard');
  ...
  describe('User is logged out', () => {
    ...
    let component;
    beforeEach(() => component = mount(<BrowserRouter><Appbar isloggedIn={false} /></BrowserRouter>));
