...
describe('Admin component', () => {
  ...
  it('should display start/kill download component', () => {
    expect(component.find(`[data-test='component-start-kill-downloads']`).length).toEqual(1);
  });

  it('should display pending signup requests', () => {
    expect(component.find(`[data-test='component-pending-signup-requests']`).length).toEqual(1);
  });

  it('should display usage statistics', () => {
    expect(component.find(`[data-test='component-usage-statistics']`).length).toEqual(1);
  });
});