...
describe('List of complete downloaded files', () => {
  ...
  describe('When the list is loading', () => {
    ...
    let component;
    beforeEach(() => component = mount(<CompletedFileList loading={true} />));
  ...
  describe('When the list is loaded', () => {
    ...
    let component;
    beforeEach(() => component = mount(<CompletedFileList files={completedList} />));
  ...
  describe('When list is given a limit ', () => {
    ...
    let component;
    beforeEach(() => component = mount(<CompletedFileList files={completedList} limit={2} />));
