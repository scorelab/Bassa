...
element(by.id('input_1')).sendKeys('lollipop');
 //Find the submit button and click it
element(by.css('[class="md-raised md-primary login-button md-button md-ink-ripple"]')).click();
...
element(by.id('input_1')).sendKeys('pass');
 //Find the submit button and click it
element(by.css('[class="md-raised md-primary login-button md-button md-ink-ripple"]')).click();
 //login button
  });
...
it('should go to the admin tab and start the download', function() {
// URL: #!/admin
...
element(by.css('a:nth-of-type(2)>div:nth-of-type(2)')).click(); // goes to the completed tab
// URL: #!/table
element(by.css('md-sidenav>a:nth-of-type(1)')).click(); // goes back to dashboard
// URL: #!/dashboard
}); // completes the tests.
});
